...
const ActiveSlider = () => {
  return (
    <div className="relative flex items-center justify-center flex-col h-[80vh] ">
      <Swiper
        breakpoints={{
          340: {
            slidesPerView: 2,
...
<a href="/" class="text-black block max-w-sm  sm p-6 bg-white border border-gray-100 shadow-xl rounded-3xl hover:bg-gray-100 ">
