...
const Navbar = () => {
  return (
    <div>
      <nav className="p-1  flex bg-white  items-center  top-0 left-0 right-0 z-20 ">
        ...
        <div className=" flex m-6">
            <button className="flex text-white items-center border bg-black border-gray-400 ml-52 mr-4 px-6 py-2 rounded-lg hover:border-gray-600">
               
            <Link to="/login">Login</Link>
                
            </button>
            <button className=" flex text-white items-center border bg-black border-gray-400 px-6 py-2 mr-12 rounded-lg hover:border-gray-600">
