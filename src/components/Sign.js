            ...
            <form>
              <div>
                <div class="relative flex items-center">
                  <input name="email" type="text" required class="text-center w-full text-xs border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-1 border" placeholder="Enter your email and username" />
              ...
              <div class="mt-8">
                <div class="relative flex items-center">
                  <input name="password" type="password" required class="text-center w-full text-xs border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-1 border" placeholder="Password" />
              ...
              <div class="flex items-center justify-between gap-2 mt-5">
                <div>
                  <a href="jajvascript:void(0);" class="text-black-600 font-semibold text-sm hover:underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
              <div class="mt-12 flex justify-center">
                <button type="button" class=" w-48 shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-black hover:bg-black-700 focus:outline-none">
                  Sign in
                </button>
              </div>
